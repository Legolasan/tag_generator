jQuery(function($){
    ...
    var teritiary= {
        ...
        'Job Configurations': ['--', 'CDC', 'Delta Timestamp', 'Full Load', 'Unique Incremental'],
        ...
        'Model Failures':['--', 'Intermittent', 'Invalid Query', 'Invalid Setup', 'Destination Limiation'],
        ...
        'Events Count': ['--', 'Incremental Load', 'Historical Load'],
