jQuery(function($){
    ...
    var teritiary= {
        'default_p': ['--'],
        'Issue':['--','Source','Destination','Delay in data load','Volume of data mismatch','Data load not started','Incorrect structure of data loaded','Issue with transformation','Others'],
        'Query':['--','NA'],
